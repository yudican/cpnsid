...
export const OfficeTab = () => {
    return (
        <>
                ...
                <div class="tab-pane fade active show" id="pills-office" role="tabpanel" aria-labelledby="pills-office-tab">
                    <div class="row">
                        <div class="col-lg-4 col-md-12">                           
                            <div className="card"> 
                                <div className="card-header bg-gradient-blue p-4" style={{ borderRadius: 10 }} >
                                <h4 className="card-title text-white">Dapatkan Sertifikat <br></br> Microsoft Office (MOS)</h4>
                                </div>
