...
export const TryoutAktif = ({statusBeli = ''}) => {
    ...
    return(
        ...
        {statusBeli == 'promo' ? (
            ...
            <div className="d-flex ">
                ...
                <div className="float-right pt-1">
                    <button type="button" style={{ width : "9rem" }} data-target="#undangteman" data-toggle="modal" className="btn btn-outline-secondary">Undang Teman</button>
                </div>
            </div>
            ...
            <div className="d-flex ">
                <div className="flex-1  pt-1" style={{ marginLeft : 3 }}>                     
                    <span  className="font-weight-bold" style={{ color : color.GREEN, marginLeft : "10px"}}>Sudah dimulai</span>
                </div>
            </div>
        </div>
        )}
